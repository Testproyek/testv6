...
const { Client ,MessageMedia, Location , List , Buttons} = require('whatsapp-web.js')
const fs = require('fs')
const os = require('os')
...
xpicvirus = fs.readFileSync(`./XBug/xpicvirus.png`)
//warrrrrrrrrr
...
*Please* @${m.mentionedJid[0].split`@`[0]} *to type accept/reject*`
	    ...
	    case 'family100': {
                ...
                let anufem = await fetchJson('https://raw.githubusercontent.com/BochilTeam/database/master/games/family100.json')
                let random = anufem[Math.floor(Math.random() * anufem.length)]
...
let anugas = await fetchJson('https://fatiharridho.github.io/tebaklagu.json')
...
let anupic = await fetchJson('https://raw.githubusercontent.com/BochilTeam/database/master/games/tebakgambar.json')
let result = anupic[Math.floor(Math.random() * anupic.length)]
...
let anuword = await fetchJson('https://raw.githubusercontent.com/DGXeon/fungames/main/GuessTheWord.js')
let result = anuword[Math.floor(Math.random() * anuword.length)]
...
let anusen = await fetchJson('https://raw.githubusercontent.com/DGXeon/fungames/main/GuessTheSentence.js')
let result = anusen[Math.floor(Math.random() * anusen.length)]
XeonBotInc.sendText(m.chat, `Please answer the following question\n\n${result.soal}\nTime : 60s`, m).then(() => {
...
let anulyric = await fetchJson('https://raw.githubusercontent.com/BochilTeam/database/master/games/tebaklirik.json')
let result = anulyric[Math.floor(Math.random() * anulyric.length)]
...
let anusayin = await fetchJson('https://raw.githubusercontent.com/BochilTeam/database/master/games/caklontong.json')
let result = anusayin[Math.floor(Math.random() * anusayin.length)]
...
break
	    ...
	    break
	case 'emojimix2': {
	    if (!text) throw `Example : ${prefix + command} Ã°Å¸Ëœâ€¦`
...
break
case 'playmp4': case 'video':
if(!text) throw `Example : ${prefix + command} anime whatsapp status`
const xeonplaymp4 = require('./lib/ytdl2')
let ytsmp4 = require("yt-search")
...
case 'pinterest': {
		...
		let { pinterest } = require('./lib/scraper')
            ...
            case 'waifu': {
                ...
                buffer = await getBuffer(anufux.url)
                let buttons = [{buttonId: `waifu`, buttonText: {displayText: 'Next Image'}, type: 1},{buttonId: `animemenu`, buttonText: {displayText: 'Ã¢Â¬â€¦Ã¯Â¸ÂBack'}, type: 1}]
                let buttonMessage = {
                    image: buffer,
	    ...
	    case 'couplepp': {
                m.reply(mess.wait)
                let anucpp = await fetchJson('https://raw.githubusercontent.com/iamriz7/kopel_/main/kopel.json')
...
case 'how': {
            	...
            	let gimana = [`Ummm...`, `It's Difficult Bro`, `Sorry Bot Can't Answer`, `Try Searching On Google`,`Holy Cow! Really???`,`Dizzy AhÃ°Å¸ËœÂ®Ã¢â‚¬ÂÃ°Å¸â€™Â¨, don't wanna answer`,`Ohhh I See:(`,`The Patient, Boss:(`,`Really dude Ã°Å¸ËœÂ?`]
...
XeonBotInc.sendMessage(from, { text: `*${command}*\n\nName : ${q}\nAnswer : *${sange}%*` }, { quoted: m })
      ...
      case 'hot': {
            ...
            let ments = [me, jodoh]
            let buttons = [
                        { buttonId: 'Ã°Å¸â€˜â‚¬', buttonText: { displayText: 'ðŸ¤£' }, type: 1 }
                    ]
                    await XeonBotInc.sendButtonText(m.chat, buttons, jawab, botname, m, {mentions: ments})
            }
            break
...
if (!text) return m.reply(`Where is the link?`)
       ...
       const response = await XeonBotInc.sendMessage(m.chat, { image: { url: cover_url }, caption: details }, { quoted: m })
        ...
        await XeonBotInc.sendMessage(m.chat, { audio: buffer }, { quoted: response })
break
case 'reddit':
...
"title": `[â«¹â«º - ã‘’ ${botname}]\ ðŸ¦‡Ì£Ì£Ì£Ì£Ì£Ì£Ì£Ì£âƒŸ   ...ð›€..ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦ð‘œ¦`,
"description": wm,
"currencyCode": "INR",
